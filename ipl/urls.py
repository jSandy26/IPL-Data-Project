...
urlpatterns = [
    ...
    path('api/get_deliveries/delivery/<int:id>', views.get_delivery_api, name='get_delivery_api'),
    path('api/get_matches/match/<int:id>', views.get_match_api, name='get_match_api'),
]